...
5. Send it to the current subject counterpart (resolved from channel_directory.json via the engine; NEVER a hardcoded name or channel) — your outbound message must @mention the counterpart in this thread; an unmentioned reply reaches no one.
